...
public class AESUtil {
    ...
    public static void main(String[] args) {
        String encodeRules = "zx";
        String[] keys = {"张三","123456"};

        for (String key : keys) {
            String encryptString = aesEncode(encodeRules,key);
            String decryptString = aesDecode(encodeRules,encryptString);

            System.out.println("key:"+key+"||AESEncode:"+encryptString+"||AESDecode:"+decryptString);
        }
    }
